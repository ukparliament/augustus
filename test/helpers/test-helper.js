...
const b = require('js-beautify').html;
  ...
  module.exports = {
    /**
    * This funcation sets up the paths before each test is ran.
    ...
    */
    ...
    /**
    * This funcation gets the contents of the json and html fixture files, runs the json through the appropriate dute file and then checks the output against the expected html.
