...
describe('Status banner dust component', function() {
  ...
  it('should return html from the dust component', function(done) {
    const jsonFixture = fixtureHelper.getJSONFixture('status-banner');

    shunterTestHelper.render('components__status-banner', jsonFixture, function(error, dom, output) {
      const expectedHTML = fixtureHelper.getHTMLFixture('status-banner');
